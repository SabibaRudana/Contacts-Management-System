package ContantManagementSystem;
...
public class Database {
    ...
    private String user = "sabibarudanauser";
    ...
    public void insertContact(Contact c) throws SQLException {
        String insert = "INSERT INTO `contacts`(`ID`, `First Name`, `Last Name`, `Phone Number`, `Email`) VALUES ('"
                    +c.getID()+"','"
                    +c.getFirstName()+"','"
                    +c.getLastName()+"','"
                    +c.getPhoneNumber()+"','"
